...
const {
  ...
  UNIT_APPLY_DAMAGE_LOOKUP_ROSTER_KEY_PROFILE_V4_821: KEY24_PAIR_PROFILE_V4,
...
const UNIT_APPLY_DAMAGE_LOOKUP2C_ROSTER_KEY_PROFILE_V4_821 = Object.freeze({
  ...UNIT_APPLY_DAMAGE_LOOKUP2C_ROSTER_KEY_821_PROFILE,
  id: 'rofl-16.19.821.7343-kr-unit-apply-damage-lookup2c-roster-key-candidate-v4',
  known_limits: Object.freeze([
    ...UNIT_APPLY_DAMAGE_LOOKUP2C_ROSTER_KEY_821_PROFILE.known_limits.slice(0, -1),
    'The complete native-witnessed v6 damage outcome, including the anonymous +0x1c u32, complete same-Replay roster, and physically source-bound raw-key pair are required.',
  ]),
});
...
function associateUnitApplyDamageLookup2cRosterKeys821(replay, {
  ...
  if (![DAMAGE_V3_ID, DAMAGE_V4_ID, DAMAGE_PROFILE.id, DAMAGE_V6_PROFILE.id]
    ...
    return fail('PROFILE_UNAVAILABLE', 'native +0x2c roster association requires an exact 821 v3-v6 damage profile');
  }
  ...
  const expectedKey24Pair = damage.profile_id === DAMAGE_V3_ID
    ? KEY24_PAIR_PROFILE_V1 : damage.profile_id === DAMAGE_V4_ID
      ? KEY24_PAIR_PROFILE_V2 : damage.profile_id === DAMAGE_V6_PROFILE.id
        ? KEY24_PAIR_PROFILE_V4 : KEY24_PAIR_PROFILE;
