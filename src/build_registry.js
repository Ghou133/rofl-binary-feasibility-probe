...
const BUILD_PROFILES = deepFreeze({
  ...
  '16.19.821.7343': {
    ...
    semantic_mappings: {
      ...
      cast_spell_ans_packet: 'exact 821 native 0x01da packet constructor/deserializer, callback transforms for opaque object offsets 0x148/0x14c and nested protected float at +0xe0; no successful-cast, owner, target, spell, slot or float-meaning inference',
